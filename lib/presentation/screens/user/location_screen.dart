...
class _LocationScreenState extends State<LocationScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(
          centerWidget: HeadLineText(text: 'Select Your Location',fontSize: 20.sp,),
        ),
        body: Column(
          children: [
            Row(
            ...
            Expanded(
              child: Stack(children: [
                ...
                Positioned(child: DefaultButton(onPressed: (){},label: 'Done', isExpanded: false, context: context , ), bottom: 60.h,left: 100.w,),
              ]),
            ),
          ],
        ),
