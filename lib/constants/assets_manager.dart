...
class AssetsManager {
  static const String categoriesPath = "$iconsPath/categories/";
  static const String placeholder = "$imagePath/placeholder.jpg";
  static const String notFoundImg = "$imagePath/notFoundImg.png";
  static const String splashBg = "$imagePath/splash_bg.jpg";
  static const String heart = "$imagePath/Category.png";
  static const String facebook = "$imagePath/fb.png";
  ...
  static const String sidePic = "$imagePath/sidePicTop.png";
